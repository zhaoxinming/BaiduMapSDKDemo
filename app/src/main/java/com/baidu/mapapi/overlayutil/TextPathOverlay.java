...
public class TextPathOverlay extends OverlayManager{
     ...
     */
    public TextPathOverlay(BaiduMap baiduMap) {
        super(baiduMap);
    }
        ...
        if (mRouteLine.getAllStep() != null
            ...
            for(int i = 1;i<points.size();i++) {
                ...
                if(dis > 10) {
                    ...
                    overlayOptionses.add(new TextPathMarkerOptions().text(String.valueOf(distance)+"米").textFontOption(
                            Typeface.DEFAULT_BOLD).textSize(50).points(tmpPoints).zIndex(1).textColor(0xFFFF0000));
                }
            }
        }
