...
public class ArcDemo extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // UI相关
        mClickArc=(CheckBox) findViewById(R.id.clickarc);
        ...
        // 点击arc的事件响应
        mBaiduMap.setOnArcClickListener(new BaiduMap.OnArcClickListener() {
            @Override
     ...
     * 设置Arc是否可点击
     */
    public void setArcClick(View view) {
        if (mArcOne == null || mArcTwo == null) {
            return;
        }
        CheckBox checkBox = (CheckBox) view;
        if (checkBox.isChecked()){
            mArcOne.setClickable(true);
            mArcTwo.setClickable(true);
        } else {
            mArcOne.setClickable(false);
            mArcTwo.setClickable(false);
        }
    }
