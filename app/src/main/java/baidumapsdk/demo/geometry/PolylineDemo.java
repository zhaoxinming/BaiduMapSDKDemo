...
import com.baidu.mapapi.map.ThinAndSmoothAlgorithm;
...
public class PolylineDemo extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener {
    ...
    private void initPolyline() {
        ...
        colorValue.add(0xAA00FFFF);
        colorValue.add(0xAA0000FF);
        colorValue.add(0xAA00FFFF);
        colorValue.add(0xAAFFFF00);
        // 覆盖物参数配置
        ...
        OverlayOptions ooPolyline = new PolylineOptions()
                ...
                .points(points).bloomAlpha(255).bloomType(PolylineOptions.LineBloomType.GradientA).bloomWidth(mWidth * 2).setBloomGradientASpeed(3.0f);// 折线坐标点列表 数目[2,10000]，且不能包含 null
        // 添加覆盖物
        mPolyline = (Polyline) mBaiduMap.addOverlay(ooPolyline);
        mPolyline.setLineBloomType(PolylineOptions.LineBloomType.GradientA);
        mPolyline.setBloomAlpha(120);
        mPolyline.setLineBloomDirection(LineBloomDirection.BloomUp);
        mPolyline.setBloomBlurTimes(2);
        ...
        OverlayOptions ooPolylineAA = new PolylineOptions().width(mWidth)
                ...
                .setThinAlgorithm(ThinAndSmoothAlgorithm.DOUGLAS_PEUCKER)
                .setThinFactor(4)
                .setSmoothAlgorithm(ThinAndSmoothAlgorithm.BEZIER_SMOOTH)
                .setSmoothFactor(16)
        ...
        mTexturePolyline.setThined(true);
        mTexturePolyline.setThinAlgorithm(ThinAndSmoothAlgorithm.DOUGLAS_PEUCKER);
        mTexturePolyline.setThinFactor(4);
        mTexturePolyline.setSmoothAlgorithm(ThinAndSmoothAlgorithm.BEZIER_SMOOTH);
        mTexturePolyline.setSmoothFactor(16);
    }
