...
public class SearchRouteList extends AppCompatActivity {
    ...
    private static final DemoInfo[] DEMOS = {
            ...
            new DemoInfo(R.string.demo_title_integralroute, R.string.demo_desc_integralroute, IntegralRouteSearchDemo.class),
            new DemoInfo(R.string.demo_title_driving_textpath, R.string.demo_desc_driving_textpath,
                    DrivingTextPathDemo.class),
