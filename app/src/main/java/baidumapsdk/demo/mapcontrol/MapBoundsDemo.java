...
public class MapBoundsDemo extends AppCompatActivity {
    ...
    public void setMapBounds(View v) {
        LatLngBounds bounds = new LatLngBounds.Builder()
                ...
                .build();
        // 设置显示在屏幕中的地图地理范围
        mBaiduMap.animateMapStatus(MapStatusUpdateFactory.newLatLngBounds(bounds),0);
    }
    ...
    public void setNewMapStatus(View v) {
        ...
        // 更新地图状态
        mBaiduMap.animateMapStatus(MapStatusUpdateFactory.newMapStatus(builder.build()),0);
    ...
    public void setNewLatLngZoom(View v) {
        ...
        // 地图中心点以及缩放级别
        mBaiduMap.animateMapStatus(MapStatusUpdateFactory.newLatLngZoom(latLng,18f),0);
        mMarker.setPosition(latLng);
    }
    ...
    public void setNewLatLngBounds(View v) {
        ...
        if (null != mapStatus){
            ...
            mBaiduMap.animateMapStatus(MapStatusUpdateFactory.newLatLngBounds(bounds,width,
                    height),0);
        }
    }
    ...
    public void setLatLngBoundsPadding(View v) {
        ...
        if (isShowBoundsPadding){
            ...
            mBaiduMap.animateMapStatus(MapStatusUpdateFactory.newLatLngBounds(bounds,0,0,0,600));
        }else{
            mBoundsPaddingBtn.setText("展示有padding值的地图地理范围");
            mBaiduMap.animateMapStatus(MapStatusUpdateFactory.newLatLngBounds(bounds,0,0,0,0));
        }
    ...
    public void setZoomIn(View v) {
        mBaiduMap.animateMapStatus(MapStatusUpdateFactory.zoomIn(),0);
    }
    ...
    public void setZoomOut(View v) {
        mBaiduMap.animateMapStatus(MapStatusUpdateFactory.zoomOut(),0);
    }
